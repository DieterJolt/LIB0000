...
namespace LIB0000
{
    public partial class MessagesPossibleView
    {
        #region Commands

        [RelayCommand]
        private void ToggleErrorsVisible()
        {
        ...
        #endregion
        #region Constructor
        public MessagesPossibleView(BasicService basicService, INavigationService navigationService)
        {
